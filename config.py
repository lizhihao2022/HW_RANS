...
parser = argparse.ArgumentParser(description='RANS')
...
parser.add_argument("--wandb_project", type=str, default="HW_RANS", help="wandb project name")
# Training Parameters
...
parser.add_argument("--dataset", type=str, choices=["RANS"], default="RANS")
